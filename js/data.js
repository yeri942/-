...
const infoList = [
  {
    name: '맵찔이 맵잘이 모두를 만족시킬수 있는',
    namer: '<치즈 떡볶이>',
    desc: '연애는 나에게 맡겨줘!! 치즈 떡볶이에 해당하는 당신은 연애의 모든 것들을 알고있는 척척박사로, 쉽게 연애에 성공하는 스타일이랍니다. 주로 포부가 크고 성격이 낙천적인 성향을 가지고 있고, 논리적이면서 두뇌회전이 매우 빠르다고 할 수 있어요. 말재주 또한 좋아 사교성이 좋고 유쾌하지만 화려한 것을 좋아해 허영심을 부리거나 사치를 부리기 때문에 이 점들을 주의해야 돼요. 뛰어난 능력에 자만하는 경우도 종종 있기 때문에 겸손이 필요하답니다! '
  },
  {
    name: '떡볶이의 기본. 정직한',
    namer: '<국물 떡볶이>',
    desc: '남자친구, 여자친구로써 진국인 당신! 국물 떡볶이에 해당하는 당신은 상대방만 바라보는 해바라기 연애 스타일이랍니다. 매사에 끈기가 있어 연애를 할 때 성실하고 진심을 다하는 성향을 가지고, 온화하며 따뜻한 마음을 가지고 있어요. 한 번 좋아하면 끝까지 좋아하는 의리파지만 자존심이 쌔 은근히 고집이 강하답니다. 또한 욱하는 성질이 있어 이런 부분들을 조심해야 하고, 질투심이 많아 사랑이 집착으로 바뀔 수 있어 주의해야 된답니다! '
  },
  {
    name: '너 내꺼해라! 화끈한',
    namer: '<엽기 불닭 떡볶이>',
    desc: '한 번 좋아하는 사람이 있으면 반드시 내 사람으로 만드는 당신! 엽기 불닭 떡볶이에 해당하는 당신은 썸부터 사랑까지 한 번에 직진하는 스타일이랍니다. 연애할 때 주로 이끄는 성향을 가지고 있고, 시원시원한 성격과 유쾌한 성격을 가지고 있어요. 대쪽같은 성격에다 실수를 용납하는 대인배지만 유혹에 약하고 허영때문에 들뜨는 성격이라 다른 이성의 접근에 주의해야 돼요. 또한 내가 한 말로 인해 상대방이 상처를 받을 수 있기 때문에, 항상 말 조심이 필요하답니다!'
  },
  {
    name: '매콤하지만 자극적이지 않은 마성의 매력',
    namer: '<로제 떡볶이>',
  ...
  {
    name: '바삭한 튀김에 매콤한 양념이 싸악! 그 사이에 서비스 떡이 쏘옥!',
    namer: '<튀김 범벅>',
